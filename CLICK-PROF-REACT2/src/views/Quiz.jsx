...
export default function Quiz() {
	const questions = [
		...
		},
		{
			...
			questionText: 'Firstly, I want to congratulate you all. Secondly, I would like to wish you good luck and ___ I hope you have enjoyed the course.',
			answerOptions: [
		...
		{   
            instructions: "Choose the best word to complete the sentence.",
			questionText: 'You ___ clean your teeth twice a day to avoid having problems.',
			answerOptions: [
		...
		{   
			...
			questionText: '--Jack: I think it’s going to rain. --Jill: I ___ , the clouds are clearing. \n --Jack: We’ll soon see.',
			answerOptions: [
        ...
        {   
            instructions: "Choose the best word to complete the dialogue.",
			questionText: 'Anne: Oh! I watched the new TV show last night. \n Jo: Was it any good? \n Anne: Yes. ___ the TV set is so old I could see very little.',
			answerOptions: [
        ...
        {   
            instructions: "Choose the best word to complete the sentence.",
			questionText: 'Have you got time to discuss your work now or are you ___ to leave?',
			answerOptions: [
